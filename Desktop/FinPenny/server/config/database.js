...
db.exec(`
  CREATE TABLE IF NOT EXISTS newsletter_subscribers (
    ...
    is_spam_flagged_date  DATETIME DEFAULT NULL,
    created_at            DATETIME DEFAULT CURRENT_TIMESTAMP
  )
`);

try { db.exec("ALTER TABLE newsletter_subscribers ADD COLUMN subscribed_at DATETIME DEFAULT NULL") } catch(e) {}
try { db.exec("ALTER TABLE newsletter_subscribers ADD COLUMN flagged_as_spam INTEGER DEFAULT 0") } catch(e) {}
try { db.exec("ALTER TABLE newsletter_subscribers ADD COLUMN is_spam_flagged_date DATETIME DEFAULT NULL") } catch(e) {}
