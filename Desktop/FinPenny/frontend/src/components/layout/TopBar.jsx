...
const TopBar = () => {
  return (
    <div className="w-full bg-white border-b border-gray-100">
      <div className="container mx-auto py-2 flex justify-between items-center px-14">
        ...
        <div className="hidden lg:flex items-center">
          ...
          >
            ...
            <span className="text-primary-blue font-semibold text-lg tracking-tight group-hover:text-primary-red">
              +91 94270 49936
            </span>
          </a>
          ...
          >
            ...
            <span className="text-primary-blue font-semibold text-lg group-hover:text-primary-red">
          ...
          <div className="flex space-x-2 pl-8">
            {/* Facebook */}
            <a 
              href="https://www.facebook.com/finpenny.official" 
              target="_blank" 
            ...
            {/* Linkedin */}
            <a 
              href="https://www.linkedin.com/company/finpenny" 
              target="_blank" 
              rel="noopener noreferrer"
              className="bg-primary-blue p-3 rounded text-white hover:bg-primary-red transition-colors flex items-center justify-center"
            >
